...
// custom data
$pdf_items = $invoice->get_pdf_items();
$passport_number = $pdf_items->passport_number;
$passenger_name = $pdf_items->passenger_name;
//echo $passport_number;
//$passport_number = '1111111';
?>

<div class="pdfPage"
     style="transition: border-color 200ms ease-in-out 0s; width: 1125px; height: 100px; background-color: white; display: inline-block; border-color: rgb(175, 175, 175);">
  <div class="pdfHeader" style="width: 1123px; position: relative; height: 100px;">
    <div tabindex="1" class="PDFElement" id="pdfField_11"
         style="left: 250px; top: 13.5875px; z-index: 500; position: absolute; font-size: 14px; width: 270px; height: 100px;">
  ...
  <div class="pdfContent" style="width: 1123px; position: relative; height: 100px;">
    <div tabindex="1" class="PDFElement" id="pdfField_9"
         style="left: 120px; top: 29.5625px; z-index: 500; position: absolute; font-size: 14px; width: 500px;">
    ...
    <div tabindex="1" class="PDFElement" id="pdfField_5"
         style="left: 73px; top: 196px; z-index: 500; position: absolute; font-size: 14px; width: 600px; height: 400px;">
    ...
    <div tabindex="1" class="PDFElement" id="pdfField_4"
         style="left: 270px; top: 245.588px; z-index: 500; position: absolute; font-size: 14px; width: 200px; height: 75px;">
    ...
    <div tabindex="1" class="PDFElement" id="pdfField_8"
         style="left: 220px; top: 324.6px; z-index: 500; position: absolute; font-size: 14px; width: 300px;">
      <div class="elementContent"><p style="vertical-align: top;"></p>
        <p style="text-align: center;"><strong>Membership Card</strong></p>
        <p></p></div>
    </div>
    <div tabindex="1" class="PDFElement" id="pdfField_7"
         style="left: 220px; top: 364px; z-index: 500; position: absolute; font-size: 14px; width: 300px; height: 55px; overflow: hidden;">
      <div class="elementContent">
        <table style="width:100%;">
          <tbody>
          <tr>
            <td style="vertical-align: top;"><p class="fieldLabel" style="margin:0;padding:0;">Name: <?php echo $passenger_name; ?></p></td>
          </tr>
          <tr>
    ...
    <div tabindex="1" class="PDFElement" id="pdfField_14"
         style="left: 218px; top: 432.6px; z-index: 500; position: absolute; font-size: 14px; width: 300px;">
      <div class="elementContent"><p style="vertical-align: top;"></p>
    ...
    <div tabindex="1" class="PDFElement" id="pdfField_13"
         style="left: 302px; top: 470px; z-index: 500; position: absolute; font-size: 14px; width: 300px; height: 34px;">
      <div class="elementContent"><p style="vertical-align: top;">#מספר דרכון</p></div>
    </div>
    <div tabindex="1" class="PDFElement" id="pdfField_6"
         style="left: 220px; top: 497.6px; z-index: 500; position: absolute; font-size: 14px; width: 300px; height: 59px; overflow: hidden;">
      <div class="elementContent">
        <table style="width:100%;">
          <tbody>
          <tr>
